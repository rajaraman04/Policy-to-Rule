...
| `data/sample_claims.csv` | 19 synthetic claim lines |
...
2. **Tab 1** - load *real_ncci_mue_94002* (a real 2026 NCCI Policy Manual excerpt) or *clinical_guideline_crc* (a real USPSTF clinical guideline) convert it.
...
protected health information. Two policies use real sourced text: `real_ncci_mue_94002.txt` paraphrases the CMS NCCI Policy Manual (effective Jan 1, 2026), Ch. I, Sec. V, and `clinical_guideline_crc.txt` paraphrases the USPSTF 2021 colorectal cancer screening recommendation (start age 45).